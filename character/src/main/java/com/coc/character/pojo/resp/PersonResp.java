package com.coc.character.pojo.resp;

/**
 * @author ran_ych
 * @create 2019-12-25  10:30
 * @desc  传出参数resp
 */
public class PersonResp {
     ...
     * skill.anthropology
     *
     * @param anthropology anthropology
     *
